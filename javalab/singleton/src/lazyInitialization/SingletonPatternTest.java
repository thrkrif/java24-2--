...
public class SingletonPatternTest {
	...
	public SingletonPatternTest() {
		...
		System.out.println(Integer.toHexString(System.identityHashCode(instance)));
		*/
		System.out.println("lazy initialization (Double Checked Locking) Singleton");
		...
		System.out.println("lazy initialization (Double Checked Locking) Singleton elapsedTime: " + elapsedTime + " ms");	
	}
}
